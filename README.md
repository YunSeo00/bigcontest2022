...
- 분석 목표
    1. 대출 신청 고객 예측 : 사용자의 대출 상품 조회 신청서 정보와 승인된 대출 상품 정보를 바탕으로 대출 신청 고객과 승인된 대출 상품을 예측.
    2. 모델 기반 고객 군집 분석 : 사용자 사용 기록(log data)을 이용한 군집 결과를 바탕으로 어플 메인 화면 상단 배너에 노출될 서비스 메시지 제안.
- 제공 데이터
...
#### 결측치 처리
<img width="675" alt="스크린샷 2023-01-27 오후 7 36 09" src="https://user-images.githubusercontent.com/88306013/215066127-7b45652f-ac7b-4e5d-b0c8-a6d3f05a7970.png">

#### 파생변수 생성
<img width="683" alt="스크린샷 2023-01-27 오후 7 37 09" src="https://user-images.githubusercontent.com/88306013/215066324-56429220-9369-4c61-b30b-8434aad176c6.png">
<img width="684" alt="스크린샷 2023-01-27 오후 7 37 26" src="https://user-images.githubusercontent.com/88306013/215066359-73aa0afc-09e7-47bf-aac4-e2238275f799.png">

#### 군집 및 시각화
<img width="682" alt="스크린샷 2023-01-27 오후 7 38 15" src="https://user-images.githubusercontent.com/88306013/215066522-03d96597-6708-4e43-9e5c-c6a1637ed5b0.png">
